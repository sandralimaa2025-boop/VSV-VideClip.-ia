...
import { FolderOpen, X, Film, Plus, Trash2, Calendar, Clock, ArrowRight } from 'lucide-react';
      ...
      <div className="bg-[#0c0c12] border border-violet-500/50 rounded-3xl p-6 sm:p-8 max-w-2xl w-full space-y-6 glow-purple animate-fadeIn relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-xs font-bold text-white flex items-center gap-1.5 shadow-lg shadow-violet-900/40"
          >
